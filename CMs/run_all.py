...
direct_to_dir=['D:\\zsk\\RAVEN\\RAVEN_ori\\','D:\\zsk\\RAVEN\\RAVEN-FAIR\\','D:\\zsk\\RAVEN\\I-RAVEN\\']
savestr='raven-fair-new'
for dirs in direct_to_dir:
    if dirs=='D:\\zsk\\RAVEN\\RAVEN_ori\\':
        savestr='iraven'
    if dirs=='D:\\zsk\\RAVEN\\I-RAVEN\\':
        savestr='iraven'
    if dirs=='D:\\zsk\\RAVEN\\RAVEN-FAIR\\':
        savestr='fair'
